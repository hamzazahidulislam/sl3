...
const articles = [
  {
    ...
    description: 'ever ',
    body: 'You have',
    createdAt: '2021-10-04T21:09:24.276Z',
    updatedAt: '2021-10-05T15:50:33.860Z',
    tagList: ['hamza'],
    favoritesCount: 1,
    author: {
      id: 1,
  ...
  },
  {
    ...
    description: 'ever ',
    body: 'You have',
    createdAt: '2021-10-04T20:41:23.668Z',
    updatedAt: '2021-10-04T20:41:23.668Z',
...
const favoriteIds2 = articles.map((favorite) => favorite.id);
console.log(favoriteIds2, favoriteIds);

const afterMap = articles.map((article) => {
